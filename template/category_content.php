...
<?php
  ...
  $product_stmt = $product->readCategory();
?>
 ...
 <?php
    ...
    $i++;
      ...
      if(array_key_exists($product_item['id'], $_SESSION['cart'])){
          ...
          echo "<td><a href='add_to_cart.php?id={$product_item['id']}&price={$product_item['price']}' class='btn btn-sm btn-success w-100-pct'>Add to cart</a></td>";
      }
  echo "</div>";
    echo '</tr>';
	}
